let weatherData = {location: "", description:"", maxTemp: "", minTemp :""};
...
function getData(place) {
    fetch("http://api.openweathermap.org/data/2.5/weather?q=" + place + "&units=metric&APPID=b9a098030deae92fa48e1b91be240011", {mode:"cors"})
